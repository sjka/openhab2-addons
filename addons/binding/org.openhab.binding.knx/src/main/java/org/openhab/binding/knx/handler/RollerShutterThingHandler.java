...
public class RollerShutterThingHandler extends KNXBaseThingHandler {
    ...
    public RollerShutterThingHandler(Thing thing,
    ...
    public boolean listensTo(GroupAddress destination) {
        ...
        try {
            GroupAddress address = new GroupAddress((String)getConfig().get(RollerShutterThingHandler.UP_DOWN_STATUS_GA));
        ...
        try {
            GroupAddress address = new GroupAddress((String)getConfig().get(RollerShutterThingHandler.STOP_MOVE_STATUS_GA));
        ...
        try {
            GroupAddress address = new GroupAddress((String)getConfig().get(RollerShutterThingHandler.POSITION_STATUS_GA));
    ...
    String getDPT(ChannelUID channelUID, Type command) {
        ...
        if((String)getConfig().get(RollerShutterThingHandler.UP_DOWN_GA) == null && (String)getConfig().get(RollerShutterThingHandler.POSITION_GA) != null) {
