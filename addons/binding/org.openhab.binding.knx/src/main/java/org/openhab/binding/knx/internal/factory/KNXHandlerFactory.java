...
public class KNXHandlerFactory extends BaseThingHandlerFactory {
    ...
    public final static Collection<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Lists.newArrayList(
            KNXBindingConstants.THING_TYPE_GA, KNXBindingConstants.THING_TYPE_SWITCH,
    ...
    public Thing createThing(ThingTypeUID thingTypeUID, Configuration configuration, ThingUID thingUID,
        ...
        if (KNXBindingConstants.THING_TYPE_GA.equals(thingTypeUID)) {
    ...
    private ThingUID getRollerShutterThingUID(ThingTypeUID thingTypeUID, ThingUID thingUID,
    ...
    private synchronized void registerGADiscoveryService(KNXBridgeBaseThingHandler bridgeHandler) {
        GADiscoveryService discoveryService = new GADiscoveryService(bridgeHandler);
